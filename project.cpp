...
void searchTheoThongTin(int search, int n, book mangSach[]){
    ...
    if (search = 1){
        ...
        for(int i = 0; i < n; i ++){
            if (mangSach[i].tenSach.find(data) != string::npos){ // hàm find, nếu nội dung của data trung với tenSach -> trả ra giá trị đầu tiên
    ...
    if (search = 2){
        ...
        bool checkTimThongTin = false; // tra ve false neu kh tim duoc
        for(int i = 0; i < n; i ++){
            if (mangSach[i].tenTacGia.find(data) != string::npos){ // hàm find, nếu nội dung của data trung với tenSach -> trả ra giá trị đầu tiên
                checkTimThongTin = true;                                                 // npos, tức không tìm được vị trí index của tenSach trùng với data
                mangSach[i].inSach();    
            }
        }
    ...
    if (search = 3){
        ...
        bool checkTimThongTin = false; // tra ve false neu kh tim duoc
        for(int i = 0; i < n; i ++){
            if (mangSach[i].theLoai.find(data) != string::npos){ // hàm find, nếu nội dung của data trung với tenSach -> trả ra giá trị đầu tiên
                checkTimThongTin = true;                                                 // npos, tức không tìm được vị trí index của tenSach trùng với data
                mangSach[i].inSach();    
            }
        }
    ...
    if (search = 4){
        ...
        bool checkTimThongTin = false; // tra ve false neu kh tim duoc
        for(int i = 0; i < n; i ++){
            if (mangSach[i].nxb.find(data) != string::npos){ // hàm find, nếu nội dung của data trung với tenSach -> trả ra giá trị đầu tiên
                checkTimThongTin = true;                                                 // npos, tức không tìm được vị trí index của tenSach trùng với data
                mangSach[i].inSach();    
            }
        }
